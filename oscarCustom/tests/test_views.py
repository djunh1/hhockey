...
from oscarCustom.customer.views import AccountAuthView, ProfileView, OrderHistoryView, AddressListView, \
    EmailHistoryView, ChangePasswordView, ProfileDeleteView, AddressCreateView, ProfileUpdateView
...
class AppCustomViews(TestCase):
    ...
    def test_logged_in_user_emailHistory_templates(self):
        request = self.factory.get('/sdfsdfsshop/dfacsdfsdfcousfddsfnts/emails/')
        request.user = self.user
    ...
    def test_logged_in_user_passwordChange_templates(self):
    ...
    def test_logged_in_user_profileDelete_templates(self):
    ...
    def test_logged_in_user_addressCreate_templates(self):
    ...
    def test_logged_in_user_profileUpdate_templates(self):
